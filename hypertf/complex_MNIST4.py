...
#workers = ["10.40.199.200:12202", "10.40.199.201:12202", "10.40.199.202:12203"]

#parameter_servers = ["10.40.2.203:12301"]# , "10.40.199.202:12302", "10.40.199.201:12303","10.40.199.200:12304"]
#workers = ["10.40.2.200:12204", "10.40.2.201:12202", "10.40.2.202:12203"]#, "10.40.199.202:12205"]
#cluster = tf.train.ClusterSpec({"ps": parameter_servers,
#                                "worker": workers})


tf.app.flags.DEFINE_string("ps_list", "", "Parameter servers")
...
if FLAGS.job_name == "ps":
    ...
    with tf.device(tf.train.replica_device_setter(
        ...
        with tf.name_scope('dense_conn1'):
            W_fc1_s1 = weight_variable([7*7*64, tester])
            b_fc1 = bias_variable([tester])
            h_pool2_flat = tf.reshape(h_pool2, [-1, 7*7*64])
            h_fc1 = tf.nn.relu(tf.matmul(h_pool2_flat, W_fc1_s1) + b_fc1)
        ...
        with tf.name_scope('read_out'):
            W_rd2 = weight_variable([tester, 10])
            b_rd2 = bias_variable([10])
            y_conv = tf.matmul(h_fc2_drop, W_rd2) + b_rd2
